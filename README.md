...
## How It Works
Using the [GitHub API](https://developer.github.com/v3/) we gather information about a repository, and use [pandas](https://pandas.pydata.org/) to display the information. Use the instructions below to retrieve the data. 
...
1. `docker volume create metrics`
2. `docker build . -t name_of_image`
3. `docker run -v metrics:/metrics name_of_image github.com/owner/repo_name`
#### To get data from inside volume after docker is dead
1. get docker id: `docker container ls -a`

2. copy data: `docker cp id:/metrics /path/to/file/on/host`
